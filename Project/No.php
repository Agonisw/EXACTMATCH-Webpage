...
if($flag1)
{    
  $sql="update Connection_Table set Status = 0,ConnectionTime='$currenttime' where (UserA_ID='$id2'AND UserB_ID='$id1' AND Status=1)";
 	$result = mysqli_query($link,$sql);
	  echo "<script>alert('Operation is successful！You will not be able to match the user again.');parent.location.href='Homepage.php'</script>"; 
}
else if($flag2)
{ 
