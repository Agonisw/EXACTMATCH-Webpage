...
<br>
 <div class ="head">
  <li class="dropdown">
  <a href="javascript:void(0)" class="dropbtn"  ><img src="http://dummyimage.com/100x100&text=Profile Picture"></a>
    <div class="dropdown-content">
	  <a href="Security.php">Information security</a>
	  <br>
	 <div class="container">
	    <img src="http://dummyimage.com/150x150&text=Profile Picture" alt="Profile Picture" style="width:100%">
...
<img src="img/'.$image.'" width = 125 height = 125">
 ...
 Age:&nbsp;'.$row["Age"].'<br><br>
 Resident City:&nbsp;'.$row["Resident_City"].'<br>
 Nationality:&nbsp;'.$row["Nationality"].'<br><br>
  Hobby:&nbsp;'.$row["Hobby"].'<br>
 
  <A href="#">Want to unlock more information...(This feature is not currently available)</A>
 </h5>
